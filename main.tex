...
\usepackage{booktabs}
\usepackage{xcolor}
\usepackage[automake=delayed,toc]{glossaries}
...
% Añadir el título del glosario al índice sin duplicar el encabezado.
...
\glsaddall
\printglossaries[title={Glosario},toctitle={Glosario}]
