...
\begin{itemize}
    \item \textbf{LXC 1 (Gitea v1.21 + Act Runner):} Plataforma ligera para el control de versiones y la ejecución de pipelines de CI/CD, configurada para emitir tokens gls{oidc}.
