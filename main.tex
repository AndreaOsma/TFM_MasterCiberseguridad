...
\begin{itemize}
    ...
    \item \textbf{Obtención de Imágenes Cloud-Init:} Para el despliegue de la máquina virtual destinada al clúster de K3s, se requiere una imagen base preparada para la inyección de metadatos. El script descarga la imagen genérica oficial de Debian 12 (\texttt{qcow2}) y la aprovisiona en el almacenamiento local del hipervisor (\texttt{/var/lib/vz/template/iso}).
